...
public class Receive extends Receiver implements BroadcastValues{
    ...
    SerialCommunicationListener serialCommunicationListener = new SerialCommunicationListener() {
        @Override
    ...
    public Receive(ReceiveListener listener){
        super();
        super.setSerialCommunicationListener(serialCommunicationListener);
