...
public class StartScreen extends Activity implements BroadcastValues{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        moduleSelectionMap.put(R.id.Combiner1_radioBtn, SIMPLE_COMBINER);
        moduleSelectionMap.put(R.id.Combiner2_radioBtn, WEIGHTED_COMBINER);
    ...
    public void onStartButtonClick(View btn) {
        ...
        String serverConnection = this.getPreferences(MODE_PRIVATE).getString("ServerConnection", "192.168.43.118:8080");
